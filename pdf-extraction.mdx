...
For more information on this feature, see the [changelog entry](https://guide.withvayu.com/documentation/change-log/changelog#extract-from-makes-pdf-data-uploads-easy).