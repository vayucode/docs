...
description: "Use AI to automatically parse contract PDFs and extract customer details, contract terms, pricing, and commitments into Vayu without manual data entry."
icon: "file-pdf"
---
