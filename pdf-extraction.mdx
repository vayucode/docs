---
title: "Extract contract data from PDFs with AI"
description: "Upload contract PDFs and use Vayu AI extraction to auto-populate customer details, contract terms, pricing, plans, and commitments without manual entry."
icon: "file-pdf"
---
