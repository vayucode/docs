...
description: "Use AI to parse contract PDFs and automatically extract customer details, terms, pricing, and commitments to create customers and contracts in Vayu."
icon: "file-pdf"
---
