...
description: "Use Vayu's AI-powered PDF extraction to parse contract documents and auto-create customers, contracts, pricing, and commitments from existing PDFs."
icon: "file-pdf"
---
