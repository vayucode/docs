...
description: "Upload contract PDFs and use AI to extract customer details, contract terms, pricing, and commitments directly into Vayu without manual entry."
icon: "file-pdf"
---
