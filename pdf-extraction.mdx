...
description: "Upload contract PDFs and use Vayu's AI to automatically extract customer details, contract terms, pricing, and commitments to streamline contract creation."
icon: "file-pdf"
---
