...
Connect Claude CodeUse the CLI to register the server:
...
2. Go to MCP or connectors.
3. Choose **Add custom MCP server**.
4. Paste the Vayu MCP server URL.
5. Click **Connect**.
6. Complete the browser sign-in flow when prompted.
...
- Authentication is handled through the OAuth protected-resource flow.
