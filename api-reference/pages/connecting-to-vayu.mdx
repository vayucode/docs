...
icon: 'key'
description: 'Retrieve your Client ID and API token from the Vayu app, then exchange the long-lived token for short-lived access tokens at the /login endpoint.'
---
