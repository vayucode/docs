---
title: 'Authentication and API credentials'
description: "Get your Client ID and API Token from Vayu, then exchange the token at /login for a short-lived bearer access token used on every API request."
icon: 'key'
---
