...
icon: 'key'
description: 'Get your Vayu API credentials, exchange the API token for a short-lived access token, and authenticate API requests with the two-token model.'
---
