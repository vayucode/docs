...
icon: 'key'
description: 'Get your Client ID and API Token from the Integrations page, then exchange them for short-lived access tokens to authenticate API requests to Vayu.'
---
