...
icon: 'key'
description: 'Authenticate with the Vayu API using JWT bearer tokens, configure base URLs for production and sandbox, and establish a secure connection from your application.'
---
