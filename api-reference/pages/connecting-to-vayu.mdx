...
icon: 'key'
description: "Authenticate with the Vayu API using your Client ID and API Token to obtain short-lived access tokens through the /login endpoint or the official SDKs."
---
