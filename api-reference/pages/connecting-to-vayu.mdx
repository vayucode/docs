...
description: 'Get your Client ID and API Token, exchange them for a short-lived access token via /login, and authenticate Vayu API requests with bearer auth.'
icon: 'key'
---
