---
title: 'Authenticate and connect to the Vayu API'
description: "Get API credentials, exchange a long-lived API token for short-lived access tokens, and authenticate Vayu API requests using the SDK or REST."
icon: 'key'
---
