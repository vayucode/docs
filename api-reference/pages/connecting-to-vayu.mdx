...
icon: 'key'
description: "Get Vayu API credentials, exchange your API token for a short-lived access token via /login, and authenticate requests with the Client ID header."
---
