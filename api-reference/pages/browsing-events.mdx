---
title: 'Browse and query ingested events'
icon: 'eye'
description: "Use the Vayu events query endpoint to retrieve ingested events, filter by name or customer, search time ranges, and paginate large datasets."
---
