...
icon: 'eye'
description: 'Use GET /events to retrieve ingested events by time range, filter by event name or customer, and paginate through large datasets in the Vayu API.'
---
