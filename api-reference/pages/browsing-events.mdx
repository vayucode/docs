...
icon: 'eye'
description: 'Use the GET /events endpoint to query ingested events by time range, event name, or customer, and paginate through large result sets in the Vayu API.'
---
