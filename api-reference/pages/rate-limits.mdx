...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Reference for Vayu API rate limits enforced by AWS API Gateway, including quotas, 429 throttling responses, and recommended retry and backoff strategies.'
---
