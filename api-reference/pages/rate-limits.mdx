---
title: 'Vayu API rate limits and retry strategy'
icon: 'gauge-high'
description: "Understand Vayu API rate limits, throttling thresholds, response headers, and how to back off and retry safely when hitting 429 Too Many Requests errors."
---
