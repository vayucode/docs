...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Vayu API rate limit policies, response headers, and 429 handling guidance, including recommended retry strategies and backoff patterns for integrations.'
---
