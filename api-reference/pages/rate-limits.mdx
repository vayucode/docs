...
title: 'Rate Limits'
icon: 'gauge-high'
description: "Vayu API rate limits enforced by AWS API Gateway, including the 500 requests per second cap, burst limits, and how to handle 429 responses with retries."
---
