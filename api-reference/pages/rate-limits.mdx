...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Understand AWS-enforced request and burst limits on the Vayu API, plus retry, backoff, and 429 error-handling patterns for high-throughput integrations.'
---
