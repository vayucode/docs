...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Vayu API rate limits enforced at 500 requests per second with a burst of 100, plus guidance on retries, exponential backoff, and 429 responses.'
---
