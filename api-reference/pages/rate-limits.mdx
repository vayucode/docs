...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Understand Vayu API rate limits enforced via AWS API Gateway, the response headers returned, and how to back off and retry throttled requests.'
---
