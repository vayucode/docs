...
title: 'Rate Limits'
icon: 'gauge-high'
description: 'Reference for the Vayu API rate limits enforced by AWS API Gateway, including throttling thresholds, 429 responses, and recommended retry strategies.'
---
