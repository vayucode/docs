...
title: 'Idempotency'
icon: 'rotate'
description: 'Use the ref field on Vayu events to make ingestion idempotent so you can safely retry requests without creating duplicate events or invoices.'
---
