...
title: 'Idempotency'
icon: 'rotate'
description: 'Use idempotency keys to safely retry Vayu API requests after network failures or timeouts without creating duplicate events, invoices, or records.'
---
