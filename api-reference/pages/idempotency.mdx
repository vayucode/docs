...
title: 'Idempotency'
icon: 'rotate'
description: 'Use the ref field on Vayu event ingestion requests to safely retry API calls without creating duplicate events or double-counting customer usage.'
---
