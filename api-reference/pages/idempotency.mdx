...
title: 'Idempotency'
icon: 'rotate'
description: 'Safely retry Vayu API requests without creating duplicates by attaching idempotency keys to mutating endpoints such as event ingestion and customer creation.'
---
