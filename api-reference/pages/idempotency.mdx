...
title: 'Idempotency'
icon: 'rotate'
description: 'Use the ref field on event payloads to safely retry Vayu ingestion requests without creating duplicates, ensuring exactly-once event processing semantics.'
---
