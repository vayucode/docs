---
title: 'Idempotent requests with idempotency keys'
icon: 'rotate'
description: "Use idempotency keys to safely retry Vayu API requests without creating duplicate customers, invoices, or events on network failures and timeouts."
---
