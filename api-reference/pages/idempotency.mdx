...
title: 'Idempotency'
icon: 'rotate'
description: 'Use idempotency keys with Vayu API requests to safely retry network failures and timeouts without creating duplicate customers, invoices, or events.'
---
