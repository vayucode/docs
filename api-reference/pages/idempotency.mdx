...
title: 'Idempotency'
icon: 'rotate'
description: "Use the ref field on every event to safely retry Vayu API ingestion requests after timeouts without double-counting usage or creating duplicates."
---
