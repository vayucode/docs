...
title: 'Idempotency'
icon: 'rotate'
description: 'Use the ref field on Vayu events to safely retry ingestion requests after timeouts without double-counting usage or creating duplicate records.'
---
