...
description: 'Reference for Vayu API HTTP status codes, error response payloads, and common error conditions to help you diagnose, retry, and recover from failed requests.'
---
