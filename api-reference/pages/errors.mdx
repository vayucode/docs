...
description: 'Reference for Vayu API HTTP status codes and JSON error response format, including type, code, and message fields for SDK and application error handling.'
---
