---
title: 'Vayu API error codes and response format'
icon: 'circle-exclamation'
description: "Reference for Vayu API HTTP status codes, JSON error response format, and how to handle authentication, validation, and rate-limit errors."
---
