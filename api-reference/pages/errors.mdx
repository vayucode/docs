...
description: 'Reference for Vayu API HTTP status codes, structured JSON error responses, and machine-readable type and code fields used to handle failures.'
---
