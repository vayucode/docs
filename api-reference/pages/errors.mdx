...
description: 'Reference for Vayu API HTTP status codes and JSON error response format, with error type and code fields for SDK handling and programmatic logic.'
---
