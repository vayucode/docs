...
description: 'Reference for Vayu API HTTP error codes, the JSON error response format, and how to use type and code fields for SDK and programmatic handling.'
---
