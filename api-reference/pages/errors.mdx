...
description: 'Reference for Vayu API error responses, including HTTP status codes, error type and code fields, and how to handle errors programmatically in SDKs.'
---
