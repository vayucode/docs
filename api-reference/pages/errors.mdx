...
description: "Reference for Vayu API error responses, including HTTP status codes, error types, machine-readable codes, and validation error formats for handling failures."
---
