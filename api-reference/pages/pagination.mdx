---
title: 'Paginate list endpoints in the Vayu API'
icon: 'list'
description: "Iterate through paginated Vayu API list responses using cursor and limit parameters to retrieve customers, events, invoices, and other resources at scale."
---
