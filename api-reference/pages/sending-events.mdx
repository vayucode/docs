...
icon: 'paper-plane'
description: "Send batches of usage events to Vayu through the events endpoint, with up to 1,000 events per request, idempotency via ref, and partial-success responses."
---
