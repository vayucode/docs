---
title: 'Send and ingest billing events to Vayu'
icon: 'paper-plane'
description: "Send batched usage events to Vayu's ingestion API, with required event fields, validation rules, and error handling for invalid records in a batch."
---
