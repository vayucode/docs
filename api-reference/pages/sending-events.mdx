...
icon: 'paper-plane'
description: 'Send events to Vayu in batches via POST /events, with partial-success ingestion that discards invalid events and processes valid ones for billing.'
---
