...
icon: 'paper-plane'
description: 'Send batches of usage events to Vayu for ingestion, including required fields, batch size limits, idempotency, and how invalid events are handled.'
---
