...
icon: 'paper-plane'
description: 'Send batches of usage events to the Vayu ingestion API with refIds, timestamps, customer aliases, and payloads that drive metering and invoicing.'
---
