...
icon: 'paper-plane'
description: 'Send batched usage events to Vayu via the ingestion API, with partial-failure handling so valid events are accepted even when some entries are rejected.'
---
