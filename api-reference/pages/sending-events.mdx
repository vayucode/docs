...
icon: 'paper-plane'
description: 'Send batches of usage events to Vayu for ingestion, with partial failure handling so valid events are processed while only invalid ones are discarded.'
---
