...
icon: 'paper-plane'
description: 'Send batches of usage events to Vayu using the POST /events endpoint, including required event structure, customer attribution, and validation rules.'
---
