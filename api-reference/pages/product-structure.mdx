---
title: 'Define product line items in Vayu contracts'
icon: 'box'
description: "Structure product line items within Vayu contracts — set pricing models, billing schedules, fixed fees, and usage-based charges through the API."
---
