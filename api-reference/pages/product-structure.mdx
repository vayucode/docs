...
icon: 'box'
description: 'Define products inside Vayu contracts with display names, scheduling, pricing models, and required fields for fixed and usage-based line items.'
---
