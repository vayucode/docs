...
icon: 'box'
description: 'Reference for defining product line items in Vayu contracts, including pricing models, billing schedules, fixed fees, usage-based fees, and tiers.'
---
