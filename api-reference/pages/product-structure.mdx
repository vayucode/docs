...
icon: 'box'
description: 'Define product line items in Vayu contracts, including base fields, scheduling, and pricing models for fixed fees, recurring charges, and metered usage.'
---
