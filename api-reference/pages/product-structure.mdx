...
icon: 'box'
description: 'Define products as contract line items in Vayu, including pricing models, billing schedules, fixed and usage-based charges, and product configuration.'
---
