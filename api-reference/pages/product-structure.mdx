...
icon: 'box'
description: 'Define product line items inside a Vayu contract, including pricing models, billing schedules, meter references, and base configuration fields.'
---
