...
icon: 'box'
description: 'Define product line items inside Vayu contracts, including pricing models, aggregation methods, meters, and base amounts used to bill customers.'
---
