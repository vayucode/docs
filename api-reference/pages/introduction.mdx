---
title: 'Vayu API'
description: 'Introduction to the Vayu REST API for usage-based billing, covering authentication, base URLs, and supported resources for events, customers, and contracts.'
---
