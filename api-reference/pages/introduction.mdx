---
title: 'Vayu API'
description: 'REST API reference for the Vayu billing platform covering customers, contracts, catalog products, events, invoices, credits, measurements, and webhooks.'
---
