---
title: 'Vayu API'
description: 'Programmatic REST API reference for managing Vayu customers, contracts, catalog products, events, invoices, credits, measurements, and webhook subscriptions.'
---
