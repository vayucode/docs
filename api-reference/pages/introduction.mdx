---
title: 'Vayu API reference for usage-based billing'
description: "REST API reference for the Vayu billing platform — manage customers, contracts, products, events, invoices, credits, and webhooks via HTTP or SDKs."
---
