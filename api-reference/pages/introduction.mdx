---
title: 'Vayu API'
description: 'Reference for the Vayu REST API to manage customers, contracts, catalog products, events, invoices, credits, measurements, and webhook subscriptions.'
---
