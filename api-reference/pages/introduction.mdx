...
<Note>
Looking for the new simpler REST surface with single-header authentication? See the [Public API (v1)](/api-reference/pages/public-api-v1) reference.
</Note>

<CardGroup cols="3">
  <Card title="Public API (v1)" icon="rocket" href="/api-reference/pages/public-api-v1">
    The new versioned REST API with single-header `x-api-key` authentication
  </Card>
