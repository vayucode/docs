...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe to Vayu webhooks to receive real-time notifications for invoice, customer, contract, and event changes, including signature verification.'
---
