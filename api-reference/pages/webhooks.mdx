...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe to Vayu webhooks to receive signed real-time POST notifications for billing events such as invoice creation, payment, and contract changes.'
---
