...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe webhooks to receive real-time notifications from Vayu when invoices, customers, contracts, payments, and events change in your account.'
---
