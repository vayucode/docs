...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe to Vayu webhooks to receive real-time notifications for invoice, contract, customer, and payment events and trigger downstream workflows.'
---
