...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe to Vayu webhooks to receive signed POST callbacks when billing events occur, including invoice approvals, payments, and contract updates.'
---
