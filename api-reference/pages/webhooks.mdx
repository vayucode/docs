...
title: 'Webhooks'
icon: 'bell'
description: "Subscribe to Vayu webhooks to receive real-time, signed POST notifications when invoices, contracts, customers, and other billing events change."
---
