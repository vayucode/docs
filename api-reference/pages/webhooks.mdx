...
title: 'Webhooks'
icon: 'bell'
description: 'Subscribe to Vayu webhooks to receive real-time, signed HTTP POST notifications about billing events like invoice approvals, payments, and customer changes.'
---
