...
title: 'Webhooks'
icon: 'bell'
description: "Subscribe to Vayu webhooks for invoice, overage, tier-crossed, renewal, and payment-status events, with signed POST payloads and signature verification."
---
