...
description: 'Test event ingestion with the Vayu dry run endpoint to validate schema, customer matching, and meter values before processing live billable usage.'
---
