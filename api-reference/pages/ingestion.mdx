...
description: 'Validate event payloads, customer matching, and meter values against the Vayu pipeline using the POST /events/dry-run endpoint without storing data.'
---
