...
description: 'Use POST /events/dry-run to validate event schemas, preview customer matching, and inspect meter values without persisting data to the Vayu database.'
---
