...
description: 'Use the dry run endpoint to validate event schema, customer matching, and meter values before sending production data to the live ingestion pipeline.'
---
