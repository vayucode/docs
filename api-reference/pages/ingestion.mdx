...
description: 'Validate event payloads against the Vayu API in dry-run mode to check parsing, attribution, and pricing logic without persisting events or affecting billing.'
---
