---
title: 'Test event ingestion with dry run'
icon: 'square-terminal'
description: "Validate event schemas, customer matching, and meter values with the Vayu dry-run ingestion endpoint before sending events to the live pipeline."
---
