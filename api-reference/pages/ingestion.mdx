...
description: "Validate event payloads, customer matching, and meter calculations through the POST /events/dry-run endpoint without persisting any data in Vayu."
---
