...
title: Introduction
icon: 'fire'
description: 'Learn how Vayu unifies usage-based pricing, fixed fees, subscriptions, tiered pricing, discounts, and contracts to streamline complex billing workflows.'
---
