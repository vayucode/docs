---
title: "Introduction to Vayu billing platform"
icon: 'fire'
description: "Vayu is a usage-based billing platform that supports flexible pricing models, contract management, event ingestion, and integrations with CRMs and ERPs."
---
