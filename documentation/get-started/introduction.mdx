---
title: 'Introduction to the Vayu billing platform'
icon: 'fire'
description: 'Learn how Vayu unifies usage-based pricing, fixed fees, subscriptions, and tiered models into a single billing platform for modern businesses.'
---
