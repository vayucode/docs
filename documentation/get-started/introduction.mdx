...
title: Introduction
icon: 'fire'
description: "Vayu unifies usage events, pricing models, and contract data into a single billing platform supporting subscription, usage-based, and tiered pricing."
---
