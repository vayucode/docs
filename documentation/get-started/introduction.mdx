---
title: "Introduction to Vayu"
icon: "fire"
description: "Vayu is a flexible billing platform for usage-based, subscription, and hybrid pricing, with a low-code UI for finance teams and a simple REST API for engineers."
---
