---
title: "Introduction to Vayu billing and pricing"
icon: 'fire'
description: "Learn how Vayu unifies usage-based, fixed, tiered, and subscription pricing into one billing platform with REST APIs, integrations, and contract automation."
---
