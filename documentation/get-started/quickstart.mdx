...
title: "Quickstart"
icon: "circle-play"
description: "Get started with Vayu by walking through customer setup, plan creation, contract assignment, event ingestion, and invoice generation in the platform user guide."
---
