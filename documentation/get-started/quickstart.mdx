...
title: "Quickstart"
icon: "circle-play"
description: "Step-by-step quickstart for Vayu covering pricing plan setup, customer creation, invoice review, usage monitoring, and data metering configuration."
---
