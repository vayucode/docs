...
title: "Quickstart"
icon: "circle-play"
description: "Get started with Vayu by exploring how to set up pricing plans, review invoices, monitor customer usage, and configure data metering in the platform."
---
