...
title: "Quickstart"
icon: "circle-play"
description: "Get started with Vayu by setting up pricing plans, monitoring customer usage, reviewing invoices, and managing data metering through the platform."
---
