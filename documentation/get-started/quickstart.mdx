...
title: "Quickstart"
icon: "circle-play"
description: "Get started with Vayu by setting up pricing plans, creating contracts, ingesting usage, generating invoices, and reviewing customer billing data."
---
