...
description: "Filter customer records in Vayu and export selected fields to CSV for use in spreadsheets, BI tools, or downstream systems like CRMs and data warehouses."
icon: "file-export"
---
