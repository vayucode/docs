...
description: "Export filtered customer data from Vayu to CSV with selectable fields covering profile information, billing configuration, and account status."
icon: "file-export"
---
