...
description: "Export customer records from Vayu to CSV with selectable fields including names, emails, status, and billing details for reporting and offline analysis."
icon: "file-export"
---
