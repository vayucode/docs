...
description: "Export customer records from Vayu to CSV with selectable fields like name, status, address, contracts, billing details, and any custom fields you've configured."
icon: "file-export"
---
