...
description: "Export filtered customer records from the Customers page to CSV, choosing which fields to include for reporting, audits, or external system imports."
icon: "file-export"
---
