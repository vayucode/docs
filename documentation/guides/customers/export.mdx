...
description: "Export customer records from Vayu to a CSV file, choosing which fields to include such as name, email, status, contract details, and contact information."
icon: "file-export"
---
