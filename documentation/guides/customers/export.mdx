...
description: "Export Vayu customer records as CSV with selected fields, including contracts, contacts, status, and addresses, for reporting or third-party tools."
---
