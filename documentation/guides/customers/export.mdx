---
title: "Export customer data from Vayu to CSV"
description: "Export Vayu customer records to CSV — including contact info, status, addresses, subsidiaries, and contract counts — for reporting and downstream systems."
icon: "file-export"
---
