...
description: "Export customer data from Vayu to CSV, choose which fields to include, and apply filters to narrow the list before downloading for reporting or backups."
icon: "file-export"
---
