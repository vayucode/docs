...
description: "Create, update, and delete customer records in Vayu using the dashboard UI or REST API, including bulk imports, account hierarchies, and integration sync."
