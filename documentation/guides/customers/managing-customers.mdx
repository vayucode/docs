...
description: "Create, update, and delete customer records in Vayu through the dashboard or the API, including bulk imports, status changes, and integration syncs."
