...
description: "Create, update, and delete customer records through the UI and API"
---
...
- **Custom fields** - Any custom field defined on the Customer entity

For custom fields, the operators and input adapt to the field's value type: text fields use "contains," number fields support "equals," "greater than," and "less than," boolean fields use "is," and enum fields use "is any of" with a multi-select of allowed values.
