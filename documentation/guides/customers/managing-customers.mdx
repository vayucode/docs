...
description: "Create, update, archive, and delete customer records in Vayu through the dashboard or API, including aliases, billing contacts, ERP mappings, and status."
