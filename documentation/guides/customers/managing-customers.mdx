...
description: "Manage customer records in Vayu by creating, updating, and deleting accounts through the dashboard or programmatically with the customers API."
---
