...
description: "Manage Vayu customer records by creating, updating, and removing accounts through the UI or the API to keep billing data accurate and complete."
---
