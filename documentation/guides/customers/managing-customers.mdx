...
description: "Create, update, and delete customer records in Vayu through the dashboard UI or REST API, with examples for managing aliases and external IDs."
