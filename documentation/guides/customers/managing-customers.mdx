...
description: "Create, update, and delete customer records in Vayu through the web app or REST API, including managing aliases, tax IDs, and external integrations."
