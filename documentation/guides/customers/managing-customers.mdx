...
description: "Create, update, and delete customer records in Vayu through both the dashboard and the API, and keep customer data in sync across integrated systems."
