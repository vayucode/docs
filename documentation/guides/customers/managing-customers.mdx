...
description: "Create, update, and delete customer records in Vayu through the UI or REST API, including contact details, billing addresses, payment terms, and custom fields."
...
<Frame>
  ![Add Customer](/images/add-customer.gif)
</Frame>
