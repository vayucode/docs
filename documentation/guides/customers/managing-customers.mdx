...
description: "Create, update, and delete customer records in Vayu through the UI or API, manage billing details, contacts, and subsidiaries across your account."
