...
description: "Add new customers to Vayu manually, by importing a CSV file, or through Salesforce and HubSpot integrations to keep customer records in sync."
icon: "users-medical"
---
