...
description: "Create a new customer in Vayu via CSV import, Salesforce or HubSpot integration, or manual entry, including company details, contacts, and tax ID."
icon: "users-medical"
---
