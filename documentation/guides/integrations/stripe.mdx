...
title: "Stripe"
icon: "stripe-s"
description: "Use Stripe as a Vayu payment provider for automatic invoice payment collection, real-time status updates, payment links, and auto-collect on customer invoices."
---
