...
icon: "stripe-s"
description: "Use Stripe as a primary payment provider in Vayu for automatic invoice sync, real-time payment status updates, embedded payment links, and auto-collection."
---
