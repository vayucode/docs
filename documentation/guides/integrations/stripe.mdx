...
description: "Connect Stripe to Vayu to process invoice payments, sync payment status, embed payment links, and enable auto-collection on customer billing workflows."
---
