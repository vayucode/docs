...
title: "Stripe"
icon: "stripe-s"
description: "Connect Vayu with Stripe to charge customers, sync payment status to invoices, and reconcile collections for both fixed and usage-based billing automatically."
---
