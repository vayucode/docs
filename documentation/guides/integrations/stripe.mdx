---
title: "Stripe"
description: "Connect Stripe to Vayu to handle invoice payments, sync payment status in real time, and enable auto-collect for usage-based and fixed billing."
---
