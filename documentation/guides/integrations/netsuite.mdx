...
icon: "n"
description: "Sync customers, sales orders, and invoices two-way between Vayu and Oracle NetSuite to align billing, revenue, and accounting workflows across both platforms."
---
