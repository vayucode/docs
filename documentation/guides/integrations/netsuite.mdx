...
icon: "n"
description: "Sync invoices, customers, payments, and revenue data between Vayu and Oracle NetSuite to automate accounting workflows and keep ERP records aligned."
---
