...
icon: "n"
description: "Connect Vayu to NetSuite for two-way sync of customers, invoices, subsidiaries, and revenue data, automating accounting and financial close workflows."
---
