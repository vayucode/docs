---
title: "QuickBooks integration: two-way invoice and revenue sync"
description: "Sync Vayu invoices, payments, refunds, customers, and products with QuickBooks using manual, bulk, and automatic sync modes for billing and accounting."
---
