...
description: "Connect Vayu and QuickBooks for two-way invoice and revenue sync, with manual, bulk, or auto-sync options and built-in retry, dedup, and error tracking."
---
