...
description: Automatically extract customer and contract data from PDF documents using AI
---
...
For more information on this feature, see the [changelog entry](/documentation/change-log/changelog#extract-from-makes-pdf-data-uploads-easy).

## Related resources

- [Adding a customer](/documentation/guides/customers/adding-a-customer)
- [Plan templates and contracts](/documentation/guides/plans-and-pricing/plan-templates-and-contracts)
- [Assign plan to customer](/documentation/guides/plans-and-pricing/assign-plan-to-customer)
