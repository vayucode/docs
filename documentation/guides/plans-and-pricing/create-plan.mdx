---
title: 'Create Plan'
description: 'Create a new pricing plan in Vayu by adding fixed fees, usage charges, and product line items, then setting start date, duration, and billing interval.'
---
