---
title: "Create Plan"
description: "Create a new pricing plan in Vayu by defining commercials, products, payment schedule, and contract terms that can be assigned to one or many customers."
icon: "plane-engines"
---
