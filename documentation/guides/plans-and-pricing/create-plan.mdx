...
description: "Build a new pricing plan in Vayu by combining fixed fees, usage charges, and tiered pricing, then setting plan duration, billing intervals, and start dates."
icon: "plane-engines"
---
