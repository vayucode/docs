...
<Tip>
    **Please Note** <br/>
    ...
    Base amounts are **not supported on Tiered Subscription** products, since they already charge a flat rate per tier. If you switch a product's pricing model to Tiered Subscription, any previously set base amount is removed at submit. <br/>
