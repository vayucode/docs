...
**When to use:** when there is a mistake or some wrong pricing definition and no invoices have been approved or issued to customers
...
when the contract is processed ‘live’ and ‘active’ however, there are new pricing / products that need to be updated and added to the current contract.
...
3. Invoices that had already been **approved** under the old contract **will remain as is** - in cases of duplication or irrelevant invoice can be either deleted or tagged as ‘Cancelled’
