...
2. System will re-generate invoices for the selected period. Invoices which are on ‘**Draft**’ and ‘**In** **review**’ will be deleted and **regenerated** according to the updated terms.
