...
When a contract is created from an uploaded or imported PDF (for example, through [Extract from PDF](/documentation/change-log/changelog)), the original document is preserved and viewable from the contract page.

To open the attached PDF, navigate to the contract and click the attachment icon. The PDF opens in an inline viewer so you can verify the source document while reviewing the structured contract data extracted into Vayu.

Use this when you need to:

- Confirm that extracted contract terms match the signed agreement
- Reference the original document during contract revisions
- Share the source PDF with finance or legal stakeholders
