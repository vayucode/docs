---
title: "Contract lifecycle: status, edits, and revisions"
description: "Manage Vayu contract lifecycle by tracking active and terminated status, editing draft contracts, and creating revisions for renewals or updated terms."
---
