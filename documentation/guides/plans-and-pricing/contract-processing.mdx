...
description: "Manage the full Vayu contract lifecycle: active, inactive, and terminated states, contract edits, renewals, and how status changes affect invoicing."
---
