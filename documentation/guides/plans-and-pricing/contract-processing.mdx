...
description: "Manage Vayu contract lifecycles by tracking active, inactive, and terminated states and editing terms to control automated invoice generation."
icon: "arrows-spin"
---
