...
**When to use update contract terms** when the contract is process ‘live’ and ‘active’ however, there are new pricing / products that need to be updated and added to the current contract.
