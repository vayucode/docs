...
description: "Understand how Vayu processes contracts from active and inactive states through edits, terminations, and renewals to drive accurate invoice generation."
icon: "arrows-spin"
---
