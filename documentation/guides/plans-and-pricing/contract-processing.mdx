...
- **Expired**
  A contract automatically transitions to **Expired** once its end date has passed. No new invoices are generated for expired contracts. If you extend the end date of an expired contract to a future date, the contract is automatically reactivated and its status returns to **Active**, resuming the regular billing cycle through the new end date.
- **Terminated** 
