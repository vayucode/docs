...
description: "Manage Vayu contract status transitions between active, inactive, and terminated, edit pre-billing contracts, and control automated invoice generation."
---
