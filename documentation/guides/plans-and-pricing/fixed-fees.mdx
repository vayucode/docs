---
title: "Fixed fees: one-time, subscription, and contract billing"
description: "Configure fixed-price service fees in Vayu using one-time charges, subscriptions, contract terms, or commission models for recurring or upfront billing."
icon: "money-bill-1"
---
...
- **Pricing Settings**
  ...
  - **Add Seats** – Adding seats will multiply the price according to the number of seats added. So, if the subscription price is \$100 per month, and you add five seats, the monthly price will be \$500. The number of seats can be adjusted throughout the contract’s lifecycle. <img src="/images/AddSeats.gif" alt="Add Seats" />
- **Schedule**
...
- **Pricing Settings**
  ...
  - **Add Discount** – Apply a discount to the subscription using a specified fixed amount or percentage (%). You can set how many recurring charges the discount applies to, or apply it to every subscription charge for the full duration of the subscription.
- **Schedule**
  - **Define Installments** – Split this item’s total into multiple scheduled payments. Click on **Set advanced installments** to open the window below: <img src="/images/Screenshot2025-12-30at10.08.31.png" alt="Screenshot2025 12 30at10 08 31" />
