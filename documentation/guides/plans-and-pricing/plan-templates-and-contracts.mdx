...
description: "Use Vayu plan templates as reusable pricing blueprints to spin up customer contracts quickly with fixed fees, usage-based fees, or a combination."
icon: "paint-roller"
---
