...
description: "Use plan templates in Vayu to define reusable pricing tiers, then convert them to customer contracts that hold commercial terms, products, and pricing."
icon: "paint-roller"
---
