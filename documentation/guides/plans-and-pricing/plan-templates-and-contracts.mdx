...
description: "Build reusable plan templates with fixed and usage-based fees, then turn them into customer contracts that capture commercial terms and billing logic."
icon: "paint-roller"
---
