...
description: "Use Vayu plan templates to standardize pricing across customers and convert them into individual contracts that hold the commercial terms for each account."
icon: "paint-roller"
---
