...
description: 'Build reusable plan templates with fixed and usage-based fees in Vayu, then assign them to customers as contracts to drive automated invoicing.'
---
