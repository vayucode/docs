...
description: "Use Vayu plan templates to standardize pricing across customers, then turn each template into a unique customer contract with its own commercial terms."
icon: "paint-roller"
---
