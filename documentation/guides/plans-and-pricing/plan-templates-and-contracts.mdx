...
description: "Build reusable plan templates with fixed and usage-based fees, then assign them to customers to automatically generate contracts and start billing."
---
