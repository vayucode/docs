---
title: "Pricing and product line items in Vayu plans"
description: "Combine fixed and usage-based product line items in Vayu plans to model flexible pricing structures for any customer contract or billing scenario."
icon: "arrow-progress"
---
