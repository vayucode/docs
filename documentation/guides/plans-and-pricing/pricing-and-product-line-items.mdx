...
description: "Combine fixed fees, usage-based pricing, and hybrid models in a Vayu plan, configuring product line items, billing intervals, and discounts for each customer."
icon: "arrow-progress"
---
