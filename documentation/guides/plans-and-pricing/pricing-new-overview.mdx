...
description: "Configure pricing models in Vayu, including fixed fees, usage-based pricing, tiered rates, minimum commitments, and reusable plan templates for contracts."
sidebarTitle: "Overview"
icon: "book-open"
---

The **Plans & Pricing** section defines how products, subscriptions, and usage are priced across your customer contracts. It provides a centralized location for configuring pricing structures that can be reused across billing workflows and integrated into customer agreements.

Pricing is managed in the Plans & Pricing section of Vayu. Whenever you create a plan, you have many options for setting payment schedules, defining contract terms, and more. In Vayu, the contract anchors the products, their price, and any modifications to each product (commitment, base price, billing interval, etc). Each contract can hold an unlimited number of Fixed Fee product(s) and/or Usage-Based products.

Pricing configuration supports a wide range of commercial models, including fixed fees, usage-based pricing, tiered pricing, minimum commitments, and contract-based billing structures. This section of Vayu is designed to help launch new pricing models, update existing commercial terms, or standardize reusable plans across customers.

At the top of the page, you’ll find an overview of available pricing components and configuration tools. Below that, plans and pricing objects are organized to support both operational billing workflows and long-term pricing management across your revenue operations process.
