...
description: "Set up customer contracts in Vayu's Plans & Pricing section with fixed fees, usage-based products, payment schedules, contract terms, and modifiers."
