...
description: 'Define products in Vayu using the TypeScript SDK CreateProduct method, including aggregation methods, meters, and unit pricing used to bill customer usage.'
---
