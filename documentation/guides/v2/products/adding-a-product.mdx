...
description: "Create products in Vayu programmatically using the TypeScript SDK by sending a CreateProductPayload with names, aggregation methods, and pricing configs."
---
