...
description: 'Use the Vayu TypeScript SDK to create products with names, event names, and aggregation methods so the platform can meter usage and apply pricing.'
---
