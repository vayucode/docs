...
description: 'Define products in Vayu using the TypeScript SDK with event name, aggregation method, and tiered pricing configuration for usage-based billing.'
---
