...
description: "Create products in Vayu using the v2 TypeScript SDK by passing CreateProductPayload with aggregation methods, pricing, and configuration options."
---
