...
description: "Define new products in Vayu using the v2 TypeScript SDK. Configure pricing, billing rules, and metering options for usage-based and fixed offerings."
---
