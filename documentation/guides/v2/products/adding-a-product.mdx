...
description: 'Create products in Vayu with the TypeScript SDK v2, configure aggregation methods, and build a CreateProductPayload representing each billable service.'
---
