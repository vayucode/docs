...
description: "Define billable products in Vayu using the TypeScript SDK with event names and aggregation methods like Count to power usage-based pricing models."
---
