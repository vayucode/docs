---
title: 'Adding a Product with the SDK'
description: 'Create new Vayu products programmatically using the v2 TypeScript SDK with CreateProductPayload and AggregationMethods to define metered billing units.'
sidebarTitle: 'Adding a Product'
---
