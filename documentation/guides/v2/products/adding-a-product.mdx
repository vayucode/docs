---
title: 'Adding a Product (v2 SDK)'
description: "Create products in Vayu using the v2 TypeScript SDK with event names, count or sum aggregation methods, and tiered pricing structures for usage-based billing."
---
