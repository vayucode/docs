...
description: "Use the Vayu TypeScript SDK to add products that represent goods or services, then attach them to plans, contracts, and metered usage workflows."
---
