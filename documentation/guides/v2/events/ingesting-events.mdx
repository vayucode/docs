...
description: "Send usage events to Vayu using the TypeScript SDK ingest method with IngestEventPayload, supporting names, timestamps, properties, and 50 MB payloads."
---
