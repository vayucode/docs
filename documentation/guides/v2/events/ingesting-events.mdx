---
title: 'Ingest usage events with the Vayu TypeScript SDK'
description: 'Send usage events to Vayu with the TypeScript SDK ingest method using event names, timestamps, and properties to power usage-based billing accurately.'
---
