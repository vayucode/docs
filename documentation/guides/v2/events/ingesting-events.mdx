---
title: 'Ingesting Events with the SDK'
description: 'Send usage events to Vayu using the v2 TypeScript SDK ingest method with name, timestamp, and properties fields, supporting payloads up to 50MB in size.'
sidebarTitle: 'Ingesting Events'
---
