---
title: 'Ingest events with the Vayu v2 TypeScript SDK'
description: "Send usage events to Vayu using the v2 TypeScript SDK — call the ingest method with name, timestamp, and properties to track customer activity."
---
