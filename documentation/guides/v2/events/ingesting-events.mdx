...
description: 'Send usage events to Vayu with the TypeScript SDK v2 ingest method, build IngestEventPayload objects, and stream up to 50 MB of activity per request.'
---
