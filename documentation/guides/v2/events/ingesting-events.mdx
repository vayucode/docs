...
description: "Send usage events to Vayu using the TypeScript SDK ingest method with name, timestamp, and properties payloads of up to 50MB for usage-based billing."
---
