---
title: 'Ingesting Events (v2 SDK)'
description: "Send usage events to Vayu through the v2 TypeScript SDK ingest method with customer aliases, event names, and arbitrary properties up to 50MB per payload."
---
