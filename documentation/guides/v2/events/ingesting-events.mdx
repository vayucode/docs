...
description: "Use the Vayu TypeScript SDK to send usage events that track user interactions with your products and feed into usage-based billing calculations."
---
