...
description: 'Send usage events to Vayu using the TypeScript SDK ingest method with payloads of up to 50 MB, including names, timestamps, properties, and customer references.'
---
