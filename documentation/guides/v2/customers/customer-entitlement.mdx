...
description: "Grant a customer a unique product version with custom pricing using entitlement revisions in the Vayu TypeScript SDK, scoped by asOf effective dates."
---
