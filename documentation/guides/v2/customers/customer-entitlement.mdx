---
title: "Customer entitlements: per-customer product pricing"
description: "Use Vayu customer entitlements to grant a customer a unique version of a product with custom pricing configurations and revisions over the contract life."
---
