---
title: 'Customer entitlements: per-customer pricing revisions'
description: "Use customer entitlements in Vayu to grant individual customers unique product versions, pricing revisions, and future-dated changes via the SDK."
---
