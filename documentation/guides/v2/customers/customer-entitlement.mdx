...
description: 'Grant a customer a unique product version with custom pricing using entitlements in the Vayu TypeScript SDK, including support for revisions.'
---
