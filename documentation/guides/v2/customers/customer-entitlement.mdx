...
description: 'Use customer entitlements in the Vayu TypeScript SDK v2 to give a customer a unique product version with custom pricing, revisions, and as-of dates.'
---
