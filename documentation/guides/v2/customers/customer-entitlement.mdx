...
description: 'Use Vayu customer entitlements to grant a customer a unique pricing or product configuration via revisions, supporting per-account overrides and future updates.'
---
