---
title: 'Set customer entitlements with the Vayu TypeScript SDK'
description: 'Grant per-customer product entitlements with the Vayu SDK to apply unique pricing or revisions, and schedule future revisions using asOf dates.'
---
