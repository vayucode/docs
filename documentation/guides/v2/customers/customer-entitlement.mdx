...
description: "Grant customers unique product versions in Vayu using the v2 SDK, with revision-based entitlements that apply customer-specific pricing as of given dates."
---
