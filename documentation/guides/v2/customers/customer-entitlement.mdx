...
description: "Use customer entitlements in Vayu to grant a customer a unique product version with custom pricing and revisions, applied via the SDK or API."
---
