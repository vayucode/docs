...
description: 'Call the Vayu SDK invoices.calculate method to preview invoice totals, line item breakdowns, discounts, and revision-based pricing in real time.'
---
