...
description: 'Calculate dynamic invoices in real time with the Vayu TypeScript SDK v2, inspect price breakdowns, and review pricing revisions before approval.'
---
