...
description: "Use the Vayu TypeScript SDK to calculate invoices in real time, returning the latest pricing, line items, taxes, and totals before approval and finalization."
---
