...
description: "Calculate invoice totals dynamically in Vayu using the v2 TypeScript SDK, with a detailed price breakdown by item, revision period, and customer entitlement."
---
