...
description: "Calculate invoices on demand in Vayu using the v2 TypeScript SDK — preview real-time totals, line items, and amounts before approving and storing them."
---
