...
description: "Calculate invoices in real time with the Vayu TypeScript SDK to preview totals, line items, and price breakdowns before approval and immutable storage."
---
