...
description: 'Calculate Vayu invoices in real time with the TypeScript SDK to preview totals, line items, taxes, and discounts before approving and storing the final invoice.'
---
