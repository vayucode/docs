...
description: 'Calculate invoices dynamically in real time with the Vayu TypeScript SDK to preview totals, price breakdowns, and revision-aware item pricing.'
---
