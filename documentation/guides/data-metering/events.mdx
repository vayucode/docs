---
title: "Events"
description: "Review raw event data ingested into Vayu, filter by customer alias, event name, ref, or date range, and validate the metering pipelines that drive billing."
