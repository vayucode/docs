---
title: "Events and data metering"
description: "Inspect raw event data ingested into Vayu, filter by date, customer alias, source, or refId, and validate metering pipelines that drive usage billing."
