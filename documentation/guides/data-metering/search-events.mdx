---
title: "Search Events"
description: "Query and filter usage events to analyze customer activity and troubleshoot billing"
---
...
Filter events using these parameters:

- `startTime` - Beginning of timestamp range (ISO 8601 format)
- `endTime` - End of timestamp range (ISO 8601 format)
...
```bash
GET /events?startTime=2023-11-01T00:00:00Z&endTime=2023-11-30T23:59:59Z&eventName=api_call&limit=100
```
