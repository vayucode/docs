...
description: "Ingest pricing events, also called measurements, to record customer usage activity and feed accurate, real-time data into your usage-based billing model."
---
