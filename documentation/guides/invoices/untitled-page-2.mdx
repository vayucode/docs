---
title: "Credit ledger"
description: "Audit every grant, deduction, and application of customer credits in Vayu using the credit ledger, with a running balance for each transaction."
---
