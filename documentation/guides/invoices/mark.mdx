...
description: "Manually mark Vayu invoices as paid when payments arrive via wire transfers, checks, or processors that aren't connected through an integration."
---
