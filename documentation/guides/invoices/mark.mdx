...
description: "Manually update an invoice's payment status in Vayu for wire transfers, checks, cash, or other payments received outside of integrated payment processors."
