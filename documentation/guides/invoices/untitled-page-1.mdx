...
description: "Manage customer credit balances in Vayu, grant or deduct credits via the UI or API, and apply them to invoices with a fully auditable credit ledger history."
