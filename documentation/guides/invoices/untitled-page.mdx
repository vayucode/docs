...
description: "Create standalone, one-off invoices in Vayu outside of regular billing cycles to handle ad-hoc charges, manual adjustments, and special customer scenarios."
---
