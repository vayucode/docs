...
description: "Create standalone invoices in Vayu outside of regular billing cycles for ad-hoc services, manual adjustments, implementation fees, and out-of-cycle charges."
...
You can create a One-Off Invoice from either the global invoice view or directly from a specific customer.
...
One-Off Invoices sync to [QuickBooks](https://guide.withvayu.com/documentation/guides/integrations/quickbooks2) with your configured invoice numbering scheme and include all line items, tax calculations, and payment terms.
